...
class UserView(object):
    ...
    def add(self):
        ...
        if 'submit' in self.request.params:
            ...
            try:
                ...
                log.info(f'Użytkownik {self.request.user.username} dodał użytkownika {user.username}')
    ...
    def edit(self):
        ...
        if 'submit' in self.request.params:
            ...
            try:
                ...
                log.info(f'Użytkownik {self.request.user.username} zmienił dane użytkownika {user.username}')
                return HTTPFound(location=self.request.route_url('users'))
    ...
    def clear_upvotes(self):
        user = self.request.context.user
        user.upvotes = []
        log.info(f'Użytkownik {self.request.user.username} wyczyścił wszystkie rekomendacje')
